...
bwqs_pfas_met_model$OlinkID <- bwqs_data_proteins
...
write.csv(bwqs_pfas_met_model, "~/Projects/BioMe/proteome/input/exwas/all panels/batch_imputed/proteome_vs_pfas_bwqs.csv",
          row.names = F)
