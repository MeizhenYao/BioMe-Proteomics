...
write.table(bwqs_pfas_met_model, "/sc/arion/work/yaom03/biome_proteome/pfas_proteome/bwqs/proteome_vs_pfas_bwqs_cardio.txt", row.names = FALSE)
write.table(bwqs_pfas_weight, "/sc/arion/work/yaom03/biome_proteome/pfas_proteome/bwqs/bwqs_pfas_weight_cardio.txt", row.names = FALSE)
