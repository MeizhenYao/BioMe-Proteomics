...
write.table(bwqs_pfas_met_model, "/sc/arion/work/yaom03/biome_proteome/pfas_proteome/bwqs_control/proteome_vs_pfas_bwqs_cardio_control.txt", row.names = FALSE)
write.table(bwqs_pfas_weight, "/sc/arion/work/yaom03/biome_proteome/pfas_proteome/bwqs_control/bwqs_pfas_weight_cardio_control.txt", row.names = FALSE)
