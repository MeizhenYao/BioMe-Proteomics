...
write.csv(prot, "~/Projects/BioMe/proteome/input/exwas/all panels/batch_imputed/bwqs/protein_sig.csv", row.names = FALSE)
write.csv(prot_neg, "~/Projects/BioMe/proteome/input/exwas/all panels/batch_imputed/bwqs/protein_sig_neg.csv", row.names = FALSE)
write.csv(prot_pos, "~/Projects/BioMe/proteome/input/exwas/all panels/batch_imputed/bwqs/protein_sig_pos.csv", row.names = FALSE)
